					...
					<div class="sparkline13-list">
						<div class="sparkline13-hd">
							<div class="main-sparkline13-hd">
								<h1>
									All <span class="table-project-n">My Lost Item Post</span>
								</h1>
							</div>
						</div>
								...
								<table id="table" data-toggle="table" data-pagination="true"
									...
									<tbody>
										<c:forEach var="lost" items="${losts}">
											<tr>
												<td>L<c:out value="${lost.LItemID}" /></td>
												<td style="width:200;"><img src="<c:out value="${lost.photo}" />" width="200"/></td>
												<td><c:out value="${lost.LItemName}" /></td>
												<td><c:out value="${lost.LItemCategory}" /></td>
												<td><c:out value="${lost.LItemLocation}" /></td>
												<td><a
													href="/lofo/LostController?action=viewMyLost&LItemID=<c:out value="${lost.LItemID}" />"><font
														color="red">View</font></a></td>
												<td><a
													href="LostController?action=deleteLost&LItemID=<c:out value="${lost.LItemID}" />"><font
