...
<body>
	...
	<div class="mailbox-compose-area mg-b-15">
		<div class="container-fluid">
			<div class="row">
				<form action="FoundController?action=updateFound" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="panel-heading hbuilt">
										...
										<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
											...
											<img src="<c:out value="${found.photo}" />" width="500"/>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										...
										<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
											<br> <label>Date Found:</label> <input
												class="form-control" name="FItemDate" type="date" required
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group-inner">
												<label><br>Item Name:</label> <input type="text"
													...
													value="<c:out value="${found.FItemName}" />" required />
											</div>
											<div class="form-group-inner">
												...
												<div class="form-select-list">
													<select class="autocomplete form-control"
														name="FItemCategory" required>
														<option  disabled selected value=><c:out
																value="${found.FItemCategory}"/></option>
											...
											<div class="form-group-inner">
												<label>Location Found:</label><br> <font color="red">Please
													re-select the location</font>
												<div class="form-select-list">
													<select class="autocomplete form-control"
														name="FItemLocation" required>
														<option disabled selected value=><c:out
																value="${found.FItemLocation}" /></option>
											...
											<div class="form-group-inner">
												...
												<div class="form-group edit-ta-resize res-mg-t-15">
													<textarea name="FItemDescription"><c:out
															value="${found.FItemDescription}" /></textarea>
												</div>
											</div>
