...
<%@ page import="lofo.model.LostItemBean"%>
<!doctype html>
...
<body>
	...
	<div class="mailbox-compose-area mg-b-15">
		<div class="container-fluid">
			<div class="row">
				<form action="LostRegisterController" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="panel-heading hbuilt">
										...
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											...
											<br><font color="red">*</font><font color="grey" size="2">Please enter the date item lost(This will appear on your submission)</font>
											 <input class="form-control"
												name="LItemDate" type="date" required />
										</div>
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
